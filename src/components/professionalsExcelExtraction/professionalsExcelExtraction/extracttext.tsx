...
interface professionalsDocumentTextExtractorProps {
  className?: string;
}

const ProfessionalsDocumentTextExtractor: React.FC<professionalsDocumentTextExtractorProps> = ({ className = '' }) => {
...
export default ProfessionalsDocumentTextExtractor;