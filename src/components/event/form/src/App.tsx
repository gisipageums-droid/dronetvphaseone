...
// function EventsForm() {
//   const { isLogin, user } = useUserAuth();
//   const { current, next, prev, goTo } = useFormSteps(6); // Changed from 7 to 6 (5 steps + summary)
//   const [steps, setSteps] = useState<any[]>([]);
...
//         status: "ai_processing",
//         updatedAt: Date.now(),
//         version: "1.0", // Event form version
//         eventType: "conference", // You might want to make this dynamic
//       };
...
// // ✅ Token Validation API URL
// const TOKEN_VALIDATION_API_URL =
//   "https://zhjkyvrz15.execute-api.ap-south-1.amazonaws.com/dev/";
